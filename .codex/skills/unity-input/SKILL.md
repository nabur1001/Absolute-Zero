---
name: unity-input
description: Reference input actions, maps, rebinding, devices, interactions and processors when that topic is requested in Absolute Zero; adapt examples to installed APIs and current project ownership.
---

# unity-input

Read [project compatibility](../../UNITY_COMPATIBILITY.md) before using the examples. Reuse configured Input System actions and ownership. Client input submits validated intent; preserve UI/gameplay map enable/disable lifecycle.
...
- [input system api](references/input-system-api.md)
